...
class Runner:
    ...
    def __init__(self, config):
        ...
        # teaching force
        # self.use_teaching_force = self.all_args.use_teaching_force
        # self.teaching_force_rate = self.all_args.teaching_force_rate
        ...
        if self.model_dir is not None:
            ...
            print(f"restore model from {self.model_dir}")
    ...
    def restore(self, model_dir):
        ...
        print("restore model from {}".format(model_dir))
    ...
    def log_env(self, env_infos, total_num_steps):
        """
        Log env info.
        :param env_infos: (dict) information about env state_raw.
        :param total_num_steps: (int) total number of training env steps.
        """
